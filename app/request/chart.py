...
PARAMETERS = {
	...
	"indicators": [
		Parameter("ab", "Abandoned Baby", ["ab", "abandonedbaby"]),
		...
		Parameter("alligator", "Alligator", ["alligator"]),
		...
		Parameter("aroonoscillator", "Aroon Oscillator", ["aroonoscillator"]),
		Parameter("atr", "ATR", ["atr"], tradingview="ATR@tv-basicstudies", premium="Average+True+Range"),
		Parameter("atrb", "ATR Bands", ["atrb", "atrbands"]),
		Parameter("atrts", "ATR Trailing Stop", ["trailingstop", "atrts", "atrstop", "atrs", "atrtrailingstop"]),
		...
		Parameter("bearish", "All Bearish Candlestick Patterns", ["bear", "bearish", "bearishpatterns", "allbearishcandlestickpatterns"]),
		Parameter("bearishengulfing", "Bearish Engulfing Pattern", ["bearishengulfing", "bearishengulfingpattern"]),
		Parameter("bearishhammer", "Bearish Hammer Pattern", ["bearishhammer", "bearishhammerpattern"]),
		Parameter("bearishharami", "Bearish Harami Pattern", ["bearishharami", "bearishharamipattern"]),
		Parameter("bearishharamicross", "Bearish Harami Cross Pattern", ["bearishharamicross", "bearishharamicrosspattern"]),
		Parameter("bearishinvertedhammer", "Bearish Inverted Hammer Pattern", ["bearishinvertedhammer", "bearishinvertedhammerpattern"]),
		Parameter("bearishmarubozu", "Bearish Marubozu Pattern", ["bearishmarubozu", "bearishmarubozupattern"]),
		Parameter("bearishspinningtop", "Bearish Spinning Top Pattern", ["bearishspinningtop", "bearishspinningtoppattern"]),
		Parameter("bullish", "All Bullish Candlestick Patterns", ["bull", "bullish", "bullishpatterns", "allbullishcandlestickpatterns"]),
		Parameter("bullishengulfing", "Bullish Engulfing Pattern", ["bullishengulfing", "bullishengulfingpattern"]),
		Parameter("bullishhammer", "Bullish Hammer Pattern", ["bullishhammer", "bullishhammerpattern"]),
		Parameter("bullishharami", "Bullish Harami Pattern", ["bullishharami", "bullishharamipattern"]),
		Parameter("bullishharamicross", "Bullish Harami Cross Pattern", ["bullishharamicross", "bullishharamicrosspattern"]),
		Parameter("bullishinvertedhammer", "Bullish Inverted Hammer Pattern", ["bullishinvertedhammer", "bullishinvertedhammerpattern"]),
		Parameter("bullishmarubozu", "Bullish Marubozu Pattern", ["bullishmarubozu", "bullishmarubozupattern"]),
		Parameter("bullishspinningtop", "Bullish Spinning Top Pattern", ["bullishspinningtop", "bullishspinningtoppattern"]),
		...
		Parameter("cf", "Chande Forecast", ["cf", "chandeforecast"]),
		...
		Parameter("cog", "Center of Gravity", ["cog", "centerofgravity"]),
		Parameter("coppock", "Coppock", ["coppock"]),
		Parameter("cumtick", "Cumulative Tick", ["cumtick", "cumulativetick"]),
		...
		Parameter("darkcloudcoverpattern", "Dark Cloud Cover Pattern", ["darkcloudcover", "dccp", "darkcloudcoverpattern"]),
		...
		Parameter("disparityoscillator", "Disparity Oscillator", ["disparityoscillator"]),
		Parameter("donchainwidth", "Donchain Width", ["donchainwidth"]),
		Parameter("dm", "Directional Movement", ["dm", "directionalmovement"], tradingview="DM@tv-basicstudies", premium="Directional+Movement"),
		Parameter("dojipattern", "Doji Pattern", ["doji", "dojipattern"]),
		Parameter("donch", "DONCH", ["donch", "donchainchannel"], tradingview="DONCH@tv-basicstudies", premium="Donchian+Channels"),
		Parameter("downsidetasukigappattern", "Downside Tasuki Gap Pattern", ["downsidetasukigap", "dtgp", "downsidetasukigappattern"]),
		Parameter("dema", "Double EMA", ["dema", "doubleema"], tradingview="DoubleEMA@tv-basicstudies", premium="Double+EMA"),
		Parameter("dragonflydojipattern", "Dragonfly Doji Pattern", ["dragonflydoji", "ddp", "dragonflydojipattern"]),
		...
		Parameter("elderray", "Elder Ray", ["elderray"]),
		...
		Parameter("eveningdojistarpattern", "Evening Doji Star Pattern", ["eveningdojistar", "edsp", "eveningdojistarpattern"]),
		Parameter("eveningstarpattern", "Evening Star Pattern", ["eveningstar", "esp", "eveningstarpattern"]),
		...
		Parameter("forceindex", "Force Index", ["forceindex"]),
		Parameter("fullstochasticoscillator", "Full Stochastic Oscillator", ["fso", "fullstochasticoscillator"]),
		Parameter("gravestonedojipattern", "Gravestone Doji Pattern", ["gravestonedoji", "gd", "gravestonedojipattern"]),
		Parameter("gatoroscillator", "Gator Oscillator", ["gatoroscillator", "gatoro"]),
		Parameter("gopalakrishnanrangeindex", "Gopalakrishnan Range Index", ["gopalakrishnanrangeindex", "gri", "gapo"]),
		Parameter("guppy", "Guppy Moving Average", ["guppy", "gma", "rainbow", "rma", "guppymovingaverage"], premium="Guppy+Multiple+Moving+Average"),
		Parameter("guppyoscillator", "Guppy Oscillator", ["guppyoscillator", "guppyo", "rainbowoscillator", "rainbowo"]),
		Parameter("hangmanpattern", "Hangman Pattern", ["hangman", "hangingman", "hangmanpattern"]),
		Parameter("hhv", "Highest High Volume", ["highesthighvolume", "hhv"]),
		Parameter("hml", "High Minus Low", ["highminuslow", "hml"]),
		...
		Parameter("imi", "Intraday Momentum Index", ["intradaymomentumindex", "imi", "intradaymi"]),
		...
		Parameter("llv", "Lowest Low Volume", ["llv", "lowestlowvolume"]),
		...
		Parameter("medianprice", "Median Price", ["medianprice", "mp"]),
		Parameter("mom", "Momentum", ["mom", "momentum"], tradingview="MOM@tv-basicstudies", premium="Momentum"),
		Parameter("morningdojistarpattern", "Morning Doji Star Pattern", ["morningdojistar", "mds", "morningdojistarpattern"]),
		Parameter("morningstarpattern", "Morning Star Pattern", ["morningstar", "ms", "morningstarpattern"]),
		...
		Parameter("maenvelope", "Moving Average Envelope", ["maenvelope", "mae", "movingaverageenvelope"]),
		Parameter("nvi", "Negative Volume Index", ["nvi", "negvolindex", "negativevolumeindex"]),
		...
		Parameter("performanceindex", "Performance Index", ["performanceindex", "pi"]),
		Parameter("pgo", "Pretty Good Oscillator", ["prettygoodoscillator", "pgo"]),
		Parameter("piercinglinepattern", "Piercing Line Pattern", ["piercingline", "pl", "piercinglinepattern"]),
		Parameter("pmo", "Price Momentum Oscillator", ["pmo", "pricemomentum", "pricemomentumoscillator"]),
		...
		Parameter("primenumberbands", "Prime Number Bands", ["primenumberbands", "pnb"]),
		Parameter("primenumberoscillator", "Prime Number Oscillator", ["primenumberoscillator", "pno"]),
		Parameter("psychologicalline", "Psychological Line", ["psychologicalline", "psy", "psychological"]),
		Parameter("pvi", "Positive Volume Index", ["pvi", "positivevolumeindex", "posvolindex"]),
		...
		Parameter("qstickindicator", "Qstick Indicator", ["qstickindicator", "qi", "qsticks"]),
		Parameter("randomwalk", "Random Walk", ["randomwalk", "ra"]),
		Parameter("ratio", "Ratio", ["ratio"], premium="Ratio"),
		Parameter("ravi", "Ravi Oscillator", ["ravi", "ravioscillator"]),
		...
		Parameter("schaff", "Schaff", ["schaff"]),
		Parameter("shinohara", "Shinohara", ["shinohara", "shin"]),
		Parameter("shootingstarpattern", "Shooting Star Pattern", ["shootingstar", "ss", "shootingstarpattern"]),
		...
		Parameter("stolleraveragerangechannelbands", "Stoller Average Range Channel Bands", ["stolleraveragerange", "sarc", "sarcb", "stolleraveragerangechannelbands"]),
		Parameter("supertrend", "Supertrend", ["supertrend"], premium="SuperTrend"),
		Parameter("swing", "Swing Index", ["swing", "swingindex", "si"]),
		...
		Parameter("ts", "Time Series Moving Average", ["timeseriesmovingaverage", "ts"]),
		Parameter("threeblackcrowspattern", "Three Black Crows Pattern", ["threeblackcrows", "tbc", "threeblackcrowspattern"]),
		Parameter("threewhitesoldierspattern", "Three White Soldiers Pattern", ["threewhitesoldiers", "tws", "threewhitesoldierspattern"]),
		Parameter("tradevolumeindex", "Trade Volume Index", ["tradevolumeindex", "tvi"]),
		Parameter("trendintensity", "Trend Intensity", ["trendintensity", "ti"]),
		Parameter("triangularmovingaverage", "Triangular Moving Average", ["triangularmovingaverage", "trma"]),
		Parameter("tweezerbottompattern", "Tweezer Bottom Pattern", ["tweezerbottom", "tbp", "tweezerbottompattern"]),
		Parameter("tweezertoppattern", "Tweezer Top Pattern", ["tweezertop", "ttp", "tweezertoppattern"]),
		Parameter("tmfi", "Twiggs Money Flow Index", ["tmfi", "twiggsmfi", "twiggsmoneyflowindex"]),
		...
		Parameter("ulcer", "Ulcer Index", ["ulcer", "ulcerindex", "ui"]),
		...
		Parameter("vidya", "VIDYA Moving Average", ["vidya", "vidyamovingaverage"]),
		Parameter("vigor", "Vigor Index", ["vigor", "vigorindex"], tradingview="VigorIndex@tv-basicstudies", premium="Relative+Vigor+Index"),
		Parameter("vma", "Variable Moving Average", ["vma", "variablema", "varma", "variablemovingaverage"]),
		...
		Parameter("volumeroc", "Volume ROC", ["vroc", "volumeroc"]),
		Parameter("volumeunderlay", "Volume Underlay", ["volund", "volumeunderlay"]),
		...
		Parameter("weightedclose", "Weighted Close", ["weightedclose"]),
	...
	"types": [
		...
		Parameter("np", "No price", ["hp", "np", "nopri"]),
