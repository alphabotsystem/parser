...
PARAMETERS = {
	"timeframes": [
		...
		Parameter(10080, "1-week", ["7", "7d", "7day", "7-day", "7days", "w", "week", "1w", "1-week", "1week", "weekly"], tradingview="1W", premium="1W", relay="W", alternativeme="1W", cnnbusiness="1W"),
		...
		Parameter(43829, "1-month", ["30d", "30day", "30-day", "30days", "1", "1m", "m", "mo", "month", "1mo", "1month", "1-month", "monthly"], tradingview="1M", premium="1M", relay="M", alternativeme="1M", cnnbusiness="1M"),
	...
	"indicators": [
		...
		Parameter("accd", "Accumulation/Distribution", ["accd", "ad", "acc", "accumulationdistribution", "accumulation/distribution"], tradingview="Accumulation/Distribution", premium="Accumulation/Distribution"),
		...
		Parameter("adr", "Advance/Decline Ratio", ["adl", "adr", "advance/declineratio"], tradingview="Advance/Decline", premium="Advance/Decline"),
		...
		Parameter("arnaudlegouxmovingaverage", "Arnaud Legoux Moving Average", ["alma", "arnaudlegouxmovingaverage"], tradingview="Arnaud+Legoux+Moving+Average", premium="Arnaud+Legoux+Moving+Average"),
		Parameter("aroon", "Aroon", ["aroon"], tradingview="Aroon", premium="Aroon"),
		Parameter("admi", "Average Directional Movement Index", ["admi", "adx", "averagedirectionalmovementindex", "averagedirectionalindex"], tradingview="Average+Directional+Index", premium="Average+Directional+Index"),
		# Parameter("adr", "Average Day Range", ["adr", "averagedayrange"], tradingview="STD;Average%Day%Range"),
		Parameter("atr", "Average True Range", ["atr", "averagetruerange"], tradingview="Average+True+Range", premium="Average+True+Range"),
		Parameter("average", "Average Price", ["averageprice", "ap", "average"], tradingview="Average+Price", premium="Average+Price"),
		Parameter("awesome", "Awesome Oscillator", ["awesome", "ao", "awesomeoscillator"], tradingview="Awesome+Oscillator", premium="Awesome+Oscillator"),
		Parameter("balanceofpower", "Balance of Power", ["balanceofpower", "bop"], tradingview="Balance+of+Power", premium="Balance+of+Power"),
		Parameter("bollinger", "Bollinger Bands", ["bollinger", "bbands", "bb", "bollingerbands"], tradingview="Bollinger+Bands", premium="Bollinger+Bands"),
		Parameter("bbb", "Bollinger Bands %B", ["%b", "bollingerbandsb", "bollingerbands%b", "bbb"], tradingview="Bollinger+Bands+%B", premium="Bollinger+Bands+%B"),
		Parameter("width", "Bollinger Bands Width", ["width", "bbw", "bollingerbandswidth"], tradingview="Bollinger+Bands+Width", premium="Bollinger+Bands+Width"),
		# Parameter("bbp", "Bull Bear Power", ["bbp", "bullbearpower"], tradingview="STD;Bull%Bear%Power"),
		Parameter("cmf", "Chaikin Money Flow Index", ["cmf", "chaikinmoneyflow", "chaikinmoneyflowindex"], tradingview="Chaikin+Money+Flow", premium="Chaikin+Money+Flow"),
		Parameter("chaikin", "Chaikin Oscillator", ["chaikin", "co", "chaikinoscillator"], tradingview="Chaikin+Oscillator", premium="Chaikin+Oscillator"),
		Parameter("chandekrollstop", "Chande Kroll Stop", ["chandekrollstop"], premium="STD;Chande%1Kroll%1Stop"),
		Parameter("chande", "Chande Momentum Oscillator", ["chande", "cmo", "chandemomentumoscillator"], tradingview="Chande+Momentum+Oscillator", premium="Chande+Momentum+Oscillator"),
		Parameter("chopzone", "Chop Zone", ["chopzone"], tradingview="Chop+Zone", premium="Chop+Zone"),
		Parameter("choppiness", "Choppiness Index", ["choppiness", "ci", "choppinessindex"], tradingview="Choppiness+Index", premium="Choppiness+Index"),
		Parameter("cci", "Commodity Channel Index", ["cci"], tradingview="Commodity+Channel+Index", premium="Commodity+Channel+Index"),
		Parameter("crsi", "Connors RSI", ["crsi"], tradingview="Connors+RSI", premium="Connors+RSI"),
		Parameter("coppockcurve", "Coppock Curve", ["coppockcurve"], tradingview="Coppock+Curve", premium="Coppock+Curve"),
		Parameter("correlation", "Correlation Coefficient", ["correlation", "cc", "correlationcoefficient"], tradingview="Correlation+Coefficient", premium="Correlation+Coefficient"),
		...
		Parameter("detrended", "Detrended Price Oscillator", ["detrended", "dpo", "detrendedpriceoscillator"], tradingview="Detrended+Price+Oscillator", premium="Detrended+Price+Oscillator"),
		Parameter("dm", "Directional Movement", ["dm", "directionalmovement"], tradingview="Directional+Movement", premium="Directional+Movement"),
		Parameter("donch", "DONCH", ["donch", "donchainchannel"], tradingview="Donchian+Channels", premium="Donchian+Channels"),
		Parameter("dema", "Double EMA", ["dema", "doubleema"], tradingview="Double+EMA", premium="Double+EMA"),
		Parameter("eom", "Ease of Movement", ["eom", "easeofmovement"], tradingview="Ease+of+Movement", premium="Ease+of+Movement"),
		Parameter("efi", "Elder's Force Index", ["efi"], tradingview="Elder's Force Index", premium="Elder's Force Index"),
		Parameter("ema", "EMA", ["ema"], tradingview="Moving+Average+Exponential", premium="Moving+Average+Exponential", dynamic=[("length:f:", 9)]),
		Parameter("env", "Envelope", ["env"], tradingview="Envelopes", premium="Envelopes"),
		Parameter("fisher", "Fisher Transform", ["fisher", "ft", "fishertransform"], tradingview="Fisher+Transform", premium="Fisher+Transform"),
		...
		Parameter("hv", "Historical Volatility", ["historicalvolatility", "hv"], tradingview="Historical+Volatility", premium="Historical+Volatility"),
		Parameter("hull", "Hull MA", ["hull", "hma", "hullma"], tradingview="Hull+Moving+Average", premium="Hull+Moving+Average"),
		Parameter("ichimoku", "Ichimoku Cloud", ["ichimoku", "cloud", "ichi", "ic", "ichimokucloud"], tradingview="Ichimoku+Cloud", premium="Ichimoku+Cloud"),
		Parameter("keltner", "Keltner Channels", ["keltner", "kltnr", "keltnerchannel"], tradingview="Keltner+Channels", premium="Keltner+Channels"),
		Parameter("klinger", "Klinger Oscillator", ["ko", "klinger", "klingeroscillator"], tradingview="Klinger+Oscillator", premium="Klinger+Oscillator"),
		Parameter("kst", "Know Sure Thing", ["knowsurething", "kst"], tradingview="Know+Sure+Thing", premium="Know+Sure+Thing"),
		Parameter("leastsquaresmovingaverage", "Least Squares Moving Average", ["leastsquaresmovingaverage"], tradingview="Least+Squares+Moving+Average", premium="Least+Squares+Moving+Average"),
		...
		Parameter("regressionslope", "Linear Regression Slope", ["lr", "linreg", "linearregression", "regressionslope", "lrs", "linregs", "linearregressionslope"], premium="Linear+Regression+Slope"),
		...
		Parameter("macd", "MACD", ["macd"], tradingview="MACD", premium="MACD"),
		Parameter("mawithemacross", "MA with EMA Cross", ["mawithemacross"], premium="MA+with+EMA+Cross"),
		Parameter("massindex", "Mass Index", ["massindex", "mi"], tradingview="Mass+Index", premium="Mass+Index"),
		Parameter("mcginleydynamic", "McGinley Dynamic", ["mcginleydynamic"], tradingview="McGinley+Dynamic", premium="McGinley+Dynamic"),
		Parameter("medianprice", "Median Price", ["medianprice"], tradingview="Median+Price", premium="Median+Price"),
		Parameter("majorityrule", "Majority Rule", ["majorityrule"], premium="Majority+Rule"),
		Parameter("mom", "Momentum", ["mom", "momentum"], tradingview="Momentum", premium="Momentum"),
		Parameter("mf", "Money Flow Index", ["mf", "mfi", "moneyflow"], tradingview="Money+Flow+Index", premium="Money+Flow+Index"),
		# Parameter("moon", "Moon Phases", ["moon", "moonphases"], tradingview="STD;Moon%1Phases"),
		Parameter("ma", "Moving Average", ["ma", "movingaverage"], tradingview="Moving+Average", premium="Moving+Average", dynamic=[("length:f:", 9)]),
		Parameter("macross", "MA Cross", ["macross"], tradingview="MA+Cross", premium="MA+Cross"),
		...
		Parameter("obv", "On Balance Volume", ["obv", "onbalancevolume"], tradingview="On+Balance+Volume", premium="On+Balance+Volume"),
		# Parameter("oi", "Open Interest", ["oi", "openinterest"], tradingview="STD;Open%Interest"),
		Parameter("parabolic", "Parabolic SAR", ["parabolic", "sar", "psar", "parabolicsar"], tradingview="Parabolic+SAR", premium="Parabolic+SAR"),
		# Parameter("pphl", "Pivot Points High Low", ["pphl", "pivotpointshighlow"], tradingview="STD;Pivot%1Points%1High%1Low"),
		Parameter("pps", "Pivot Points Standard", ["pps", "pivot", "pivotpointsstandard"], tradingview="Pivot+Points+Standard", premium="Pivot+Points+Standard"),
		Parameter("po", "Price Oscillator", ["po", "priceoscillator"], tradingview="Price+Oscillator", premium="Price+Oscillator"),
		Parameter("pricechannel", "Price Channel", ["pricechannel"], premium="Price+Channel"),
		Parameter("pvt", "Price Volume Trend", ["pvt", "pricevolumetrend"], tradingview="Price+Volume+Trend", premium="Price+Volume+Trend"),
		Parameter("ratio", "Ratio", ["ratio"], premium="Ratio"),
		Parameter("roc", "Price ROC", ["roc", "priceroc", "proc"], tradingview="Rate+Of+Change", premium="Rate+Of+Change"),
		...
		Parameter("rsi", "RSI", ["rsi", "relativestrength", "relativestrengthindex", "relativestrengthidx"], tradingview="Relative+Strength+Index", premium="Relative+Strength+Index"),
		...
		Parameter("rvigor", "Relative Vigor Index", ["vigor", "vigorindex"], tradingview="Relative+Vigor+Index", premium="Relative+Vigor+Index"),
		# Parameter("rvat", "Relative Volume at Time", ["rvat", "relativevolumeattime"], tradingview="STD;Relative%1Volume%1at%1Time"),
		Parameter("sma", "Smoothed Moving Average", ["sma", "smoothedmovingaverage"], tradingview="Smoothed+Moving+Average", premium="Smoothed+Moving+Average", dynamic=[("length:f:", 9)]),
		# Parameter("smi", "Stochastic Momentum Index", ["smi", "stochmi", "stochasticmi", "stochasticmomentumindex"], tradingview="STD;SMI"),
		Parameter("smiei", "SMI Ergodic Indicator", ["smiei", "smiergodicindicator"], tradingview="SMI+Ergodic+Indicator/Oscillator", premium="SMI+Ergodic+Indicator/Oscillator"),
		Parameter("smieo", "SMI Ergodic Oscillator", ["smieo", "smiergodicoscillator"], tradingview="SMI+Ergodic+Indicator/Oscillator", premium="SMI+Ergodic+Indicator/Oscillator"),
		Parameter("spread", "Spread", ["spread"], premium="Spread"),
		Parameter("srsi", "Stochastic RSI", ["srsi", "stochrsi", "stochasticrsi"], tradingview="Stochastic+RSI", premium="Stochastic+RSI"),
		Parameter("stochastic", "Stochastic", ["stochastic", "stoch"], tradingview="Stochastic", premium="Stochastic"),
		...
		Parameter("supertrend", "Supertrend", ["supertrend"], tradingview="SuperTrend", premium="SuperTrend"),
		Parameter("standardrrrorbands", "Standard Error Bands", ["standardrrrorbands"], premium="Standard+Error+Bands"),
		Parameter("tema", "Triple EMA", ["tema", "tripleema"], tradingview="Triple+EMA", premium="Triple+EMA"),
		...
		Parameter("trix", "Triple Exponential Average", ["trix", "txa", "texa", "tripleexponentialaverage"], tradingview="TRIX", premium="TRIX"),
		Parameter("typicalprice", "Typical Price", ["typicalprice", "tp"], premium="Typical+Price"),
		Parameter("truestrengthindicator", "True Strength Index", ["tsi", "truestrengthindex", "truestrengthindicator"], tradingview="True+Strength+Indicator", premium="True+Strength+Indicator"),
		Parameter("trendstrengthindex", "Trend Strength Index", ["trendstrengthindex"], premium="Trend+Strength+Index"),
		Parameter("ultimate", "Ultimate Oscillator", ["ultimate", "uo", "ultimateoscillator"], tradingview="Ultimate+Oscillator", premium="Ultimate+Oscillator"),
		...
		Parameter("volatility", "Volatility Index", ["volatility", "vi", "volatilityindex"], tradingview="Volatility+Index", premium="Volatility+Index"),
		...
		Parameter("volumeoscillator", "Volume Oscillator", ["volosc", "volumeoscillator"], tradingview="Volume+Oscillator", premium="Volume+Oscillator"),
		...
		Parameter("vortex", "Vortex", ["vortex"], tradingview="Vortex+Indicator", premium="Vortex+Indicator"),
		Parameter("vwap", "VWAP", ["vwap"], tradingview="VWAP", premium="VWAP"),
		Parameter("vwma", "VWMA", ["mavw", "vw", "vwma"], tradingview="VWMA", premium="VWMA"),
		Parameter("williamsa", "Williams Alligator", ["williamsa", "williamsalligator", "wa"], tradingview="Williams+Alligator", premium="Williams+Alligator"),
		Parameter("williamsf", "Williams Fractal", ["williamsf", "williamsfractal", "wf"], tradingview="Williams+Fractal", premium="Williams+Fractal"),
		Parameter("williamsr", "Williams %R", ["williamsr", "wr", "williams%r"], tradingview="Williams+%R", premium="Williams+%R"),
		Parameter("wma", "Weighted Moving Average", ["wma", "weightedmovingaverage"], tradingview="Moving+Average+Weighted", premium="Moving+Average+Weighted"),
