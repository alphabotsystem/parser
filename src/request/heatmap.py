...
PARAMETERS = {
	...
	"style": [
		...
		Parameter("dataset", "New Zealand ETFs", ["newzealandetfs"], tradingViewEtfHeatmap="AllNZEtf"),
	...
	"preferences": [
		...
		Parameter("category", "fixed income", ["fixedincome"], tradingViewEtfHeatmap="b6e443a6c4a8a2e7918c5dbf3d45c796"),
		...
		Parameter("category", "asset allocation", ["assetallocation"], tradingViewEtfHeatmap="b090e99b8d95f5837ec178c2d3d3fc50"),
