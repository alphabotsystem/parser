...
PARAMETERS = {
	...
	"preferences": [
		...
		Parameter("category", "commercial services", ["commercialservices"], tradingViewStockHeatmap="Commercial%20Services"),
		Parameter("category", "communications", ["communications"], tradingViewStockHeatmap="Communications"),
		Parameter("category", "consumer durables", ["consumerdurables"], tradingViewStockHeatmap="Consumer%20Durables"),
		Parameter("category", "consumer non-durables", ["consumernon-durables"], tradingViewStockHeatmap="Consumer%20Non-Durables"),
		Parameter("category", "consumer services", ["consumerservices"], tradingViewStockHeatmap="Consumer%20Services"),
		Parameter("category", "distribution services", ["distributionservices"], tradingViewStockHeatmap="Distribution%20Services"),
		Parameter("category", "electronic technology", ["electronictechnology"], tradingViewStockHeatmap="Electronic%20Technology"),
		Parameter("category", "energy minerals", ["energyminerals"], tradingViewStockHeatmap="Energy%20Minerals"),
		Parameter("category", "finance", ["finance", "financialservices"], tradingViewStockHeatmap="Finance"),
		Parameter("category", "health services", ["healthservices"], tradingViewStockHeatmap="Health%20Services"),
		Parameter("category", "health technology", ["health", "healthtechnology", "healthcare"], tradingViewStockHeatmap="Health%20Technology"),
		Parameter("category", "industrial services", ["industrialservices"], tradingViewStockHeatmap="Industrial%20Services"),
		Parameter("category", "miscellaneous", ["miscellaneous"], tradingViewStockHeatmap="Miscellaneous"),
		Parameter("category", "non-energy minerals", ["non-energyminerals"], tradingViewStockHeatmap="Non-Energy%20Minerals"),
		Parameter("category", "process industries", ["processindustries"], tradingViewStockHeatmap="Process%20Industries"),
		Parameter("category", "producer manufacturing", ["producermanufacturing"], tradingViewStockHeatmap="Producer%20Manufacturing"),
		Parameter("category", "retail trade", ["retailtrade"], tradingViewStockHeatmap="Retail%20Trade"),
		Parameter("category", "technology services", ["technologyservices"], tradingViewStockHeatmap="Technology%20Services"),
